...
FACILITY_SUB_LOCATIONS = {
    ...
    "Govt. Primary Health Centre (PHC), Jhunjhunu": {
        ...
        "Jhunjhunu": ["Islampur", "Bagar", "Hetamsar", "Indali", "Bharu", "Sultana", "Dhigal", "Birmi", "Bajla", "Gura", "Titanwad", "Bharunda Kalan"],
        "Chirawa": ["Bakhtawarpura", "Padampura", "Solana", "Sultana", "Chanana", "Jakhora", "Ardawata"],
